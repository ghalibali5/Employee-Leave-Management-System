         ...
         <header id="header" class="header">
            <div class="top-left">
               <div class="navbar-header">
                  <a class="navbar-brand" href="index.php"><img src="images/digious.png" alt="Logo" style="height: 50px;"></a>
                  <a class="navbar-brand hidden" href="index.php"><img src="images/digious.png" alt="Logo"></a>
